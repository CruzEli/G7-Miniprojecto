...
class Inicio:
    def __init__(self, ventana):
        ...
        self.bg_frame = Image.open('_images_/background1.png')
        ...
        self.imagen_lateral = Image.open('_images_/vector.png')
        ...
        self.preguntados = Image.open('_images_/preguntadoss.png')
